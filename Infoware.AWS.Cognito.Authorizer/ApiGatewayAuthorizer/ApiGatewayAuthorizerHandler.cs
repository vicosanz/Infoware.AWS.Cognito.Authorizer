...
public class ApiGatewayAuthorizerHandler : ApiGatewayJWTAuthenticationHandler<ApiGatewayJWTAuthenticationSchemeOptions>
{
    public ApiGatewayAuthorizerHandler(IOptionsMonitor<AuthenticationSchemeOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock)
